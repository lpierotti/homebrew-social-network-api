...
for i in 0..5
	...
	RecipeIngredient.create(amount: Faker::Number.decimal(2), unit: Faker::Measurement.metric_weight("all"), ingredient_id: Faker::Number.between(1, Ingredient.all.length), recipe_id: Faker::Number.between(1, i))
	RecipeIngredient.create(amount: Faker::Number.decimal(2), unit: Faker::Measurement.metric_weight("all"), ingredient_id: Faker::Number.between(1, Ingredient.all.length), recipe_id: Faker::Number.between(1, i))
	RecipeIngredient.create(amount: Faker::Number.decimal(2), unit: Faker::Measurement.metric_volume("all"), ingredient_id: Faker::Number.between(1, Ingredient.all.length), recipe_id: Faker::Number.between(1, i))
	RecipeIngredient.create(amount: Faker::Number.decimal(2), unit: Faker::Measurement.metric_volume("all"), ingredient_id: Faker::Number.between(1, Ingredient.all.length), recipe_id: Faker::Number.between(1, i))
	RecipeIngredient.create(amount: Faker::Number.decimal(2), unit: Faker::Measurement.metric_volume("all"), ingredient_id: Faker::Number.between(1, Ingredient.all.length), recipe_id: Faker::Number.between(1, i))
	RecipeIngredient.create(amount: Faker::Number.decimal(2), unit: Faker::Measurement.metric_volume("all"), ingredient_id: Faker::Number.between(1, Ingredient.all.length), recipe_id: Faker::Number.between(1, i))
	RecipeIngredient.create(amount: Faker::Number.decimal(2), unit: Faker::Measurement.metric_volume("all"), ingredient_id: Faker::Number.between(1, Ingredient.all.length), recipe_id: Faker::Number.between(1, i))
